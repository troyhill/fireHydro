#' Data: 2017 fire history shapefile
#'
#' @description A shapefile of fires in 2017 occurring in Big Cypress National Preserve and Everglades National Park
#'
#' @format A shapefile of fires in 2017 in Big Cypress National Preserve and Everglades National Park
#' @docType data
