...
Figure 1. Water levels in south Florida. This map is based on the most recent EDEN water surface data. [Download this figure here.](https://github.com/troyhill/fireHydro/blob/master/docs/figures/waterLevels.png)
